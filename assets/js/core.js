...
function(t) {
    ...
    function(t, e, i) {
        ...
        t.DLMenu = function(e, i) {
            ...
            backLabel: '<svg role="img" class="df-icon df-icon--left-arrow"><use xlink:href="https://cdn.glitch.com/b4cd43f6-9402-4c6d-9e15-3a86d2ceef44%2Fnecromancers.svg#left-arrow"></use></svg> Back',
                        ...
                        function(t, e, i, n) {
                            ...
                            for (var h = 0, u = e.length; h < u; h++) {
                                ...
                                if (c._transformCoordinates(i, a), s = a[0], r = a[1], 2 & d && l(2), 4 & d && l(4), t.fillRect(s - o, r - o, n, n), !(1 & d)) {
                                    var f = t.fillStyle;
                                    t.fillStyle = "#ffaf00", t.fillRect(s - o + 1, r - o + 1, n - 2, n - 2), t.fillStyle = f
                                }
                            }
