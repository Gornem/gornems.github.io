		...
		slickCarousel: function() {
			...
			if ( slick_top_bar_carousel.exists() ) {
				slick_top_bar_carousel.slick({
					...
					slidesToShow: 4,
					variableWidth: true,
					prevArrow:"<button class='slick-prev'><svg role='img' class='df-icon df-icon--left-arrow'><use xlink:href='https://cdn.glitch.com/b4cd43f6-9402-4c6d-9e15-3a86d2ceef44%2Fnecromancers.svg#left-arrow'/></svg></button>",
					nextArrow:"<button class='slick-next'><svg role='img' class='df-icon df-icon--right-arrow'><use xlink:href='https://cdn.glitch.com/b4cd43f6-9402-4c6d-9e15-3a86d2ceef44%2Fnecromancers.svg#right-arrow'/></svg></button>",
					responsive: [
						{
							breakpoint: 768,
							settings: "unslick"
			...
			if ( slick_team_carousel.exists() ) {
				...
				slick_team_carousel.slick({
					...
					customPaging: function(slick,index) {
						...
						return '<svg role="img" class="df-icon df-icon--match-' + icon + '"><use xlink:href="https://cdn.glitch.com/b4cd43f6-9402-4c6d-9e15-3a86d2ceef44%2Fnecromancers.svg#match-' + icon + '"/></svg>';
					},
			...
			if (gmap.exists()) {
				gmap.each(function () {
					...
					if (mapStyle === 'necromancers') {
						// Skin: Necromancers
						stylesOutput = [{ "elementType": "labels.text.fill", "stylers": [ { "color": "#ffffff" } ] }, { "elementType": "labels.text.stroke", "stylers": [ { "color": "#222430" } ] }, { "featureType": "administrative.land_parcel", "elementType": "labels", "stylers": [ { "visibility": "off" } ] }, { "featureType": "landscape", "elementType": "geometry", "stylers": [ { "color": "#222430" } ] }, { "featureType": "poi", "elementType": "geometry.fill", "stylers": [ { "color": "#5e627e" } ] }, { "featureType": "poi", "elementType": "geometry.stroke", "stylers": [ { "color": "#717595" } ] }, { "featureType": "poi", "elementType": "labels.text", "stylers": [ { "visibility": "off" } ] }, { "featureType": "poi.business", "stylers": [ { "visibility": "off" } ] }, { "featureType": "poi.park", "elementType": "geometry.fill", "stylers": [ { "color": "#9e070d" } ] }, { "featureType": "road", "elementType": "geometry", "stylers": [ { "color": "#323545" } ] }, { "featureType": "road", "elementType": "labels", "stylers": [ { "color": "#ffffff" } ] }, { "featureType": "road", "elementType": "labels.icon", "stylers": [ { "visibility": "off" } ] }, { "featureType": "road", "elementType": "labels.text.fill", "stylers": [ { "color": "#ffffff" } ] }, { "featureType": "road", "elementType": "labels.text.stroke", "stylers": [ { "color": "#222430" } ] }, { "featureType": "road.local", "elementType": "labels", "stylers": [ { "visibility": "off" } ] }, { "featureType": "transit", "stylers": [ { "visibility": "off" } ] }, { "featureType": "water", "elementType": "geometry.fill", "stylers": [ { "color": "#4545fa" } ] } ];
